...
<form action="<c:url value='/admin/author/search-author-edit'/>" method="POST">
...
<form action="<c:url value='/admin/author/update-author'/>" method="POST">
    <input type="hidden" name="id" value="${author.id}"/>

    <div class="form-group">
        <label for="name">Name:</label>
        <input type="text" id="name" name="authorName" value="${author.authorName}" required/>
    </div>

    <div class="form-group">
        <button type="submit">Save</button>
        <a href="<c:url value='/admin/author/show-author'/>" class="button">Cancel</a>
    </div>
</form>
</body>
</html>
